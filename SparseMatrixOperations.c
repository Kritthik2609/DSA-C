...
int main() {
    ...
    transposed[0][0] = result[0][1];
    transposed[0][1] = result[0][0];
    transposed[0][2] = result[0][2];
    
    int numCols = result[0][1];
    ...
    for(i = 1; i < k; i++) {
    	...
    	transposed[pos][0] = result[i][1];
    	transposed[pos][1] = result[i][0];
    	transposed[pos][2] = result[i][2];
